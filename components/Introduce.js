      ...
      <div className="w-[375px] h-[880px] pt-4 flex-col flex gap-8">
        <div className="w-[343px] h-[752px] mt-[64px] mx-4 flex flex-col gap-[46px]">
          ...
          <div className="w-[343px] h-[216px] flex gap-2">
            <div>
              <h3 className="font-sans font-[600] text-[36px] text-gray-900 leading-[40px]">
                Hi, I’m Sagar 👋
              </h3>
              <p className="font-sans font-[400] text-[16px] text-gray-600 leading-[24px] mt-[8px]">
          ...
          <div className="flex flex-col gap-[8px]">
            <div className="flex gap-[8px]">
              ...
              ></img>
              <span className="font-[400] text-[16px] leading-[24px] text-gray-600 font-sans">
                Ahmedabad, India
              </span>
            </div>
            <div className="flex gap-[8px]">
          ...
          <div className="flex">
            ...
            <div className="w-[36px] h-[36px]">
              <img
                src="images/Icon.png"
                className="w-[15px] h-[15px] mt-[4px] ml-[4px]"
              ></img>
            </div>
          </div>
        </div>
