        ...
        <div className="h-9 flex justify-between">          
          ...
          <div className="hidden gap-6 xl:flex">
           ...
           <div className="border-gray-200 m-1 border mt-2"></div>
            <div className="py-[6px]"><Image src={"/images/sun-icon.png"} width={24} height={24} alt="sun"/></div>
           <div className="w-[104px] h-[36px] rounded-xl bg-gray-900">
          ...
          <div className="xl:hidden" onClick={openMenu}>
           ...
           <div className={open ? "block" : "hidden"}>
            ...
            <div className="fixed  top-0 right-0 bottom-0 h-[667px] bg-white shadow-2xl w-80 z-20">
