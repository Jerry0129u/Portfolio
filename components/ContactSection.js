      ...
      <section className="max-w-[1280px] mx-auto" id="contact">
        <div className="h-[472px] flex-col flex gap-8 ">
            ...
            {contacts.map((call, index) => (
              <div key={index} className="flex flex-col gap-1 ">
                <div className="flex justify-center gap-4">
                  ...
                  <p className="font-sans font-semibold text-base leading-7 dark:text-white">{call.contact}</p>
          ...
          <div className="flex flex-col">
            <p className="text-center font-[400] text-[16px] font-sans leading-6 text-gray-600 dark:text-white">You may also find me on these platforms!</p>
