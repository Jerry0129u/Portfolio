     ...
     return (
       <div className="w-[343px] h-[372px] rounded-xl bg-slate-600">
        <div className="w-[279px] h-[308px] m-[32px] bg-slate-500 flex flex-col gap-[16px]">
         ...
         <h4 className="font-sans font-[400] text-[16px] leading-[24px] text-gray-700">{date}</h4>
         <ul className="font-sans font-[600] text-[18px] leading-[28px] text-gray-900">{header}
