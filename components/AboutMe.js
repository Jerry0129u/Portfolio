    ...
    return  <section>
        ...
        <div className="w-[343px] h-[1562px] my-[64px] mx-4 flex flex-col">
          ...
          <div className="w-[343px] h-[300px] flex gap-[211px] mt-[24px] realtive">
            <div><img src="images/profile2.png" className="w-[240px] h-[280px] ml-[52px] mb-[20px] z-10 absolute"></img></div>
            <div><img src="images/profile-shadow.png" className="w-[280px] h-[280px] ml-[-180px] mt-[20px] z-0 absolute"></img></div>
          </div>
          <div className="mt-[48px]">
            <h3 className="font-sans font-[600] text-[24px] leading-[32px] text-gray-900">Curious about me? Here you have it:</h3>
