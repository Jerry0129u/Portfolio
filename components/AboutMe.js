...
export function AboutMe () {
    ...
    return  <section className=" bg-gray-50 dark:bg-gray-900" id="about">
    <section className="max-w-[1280px] mx-auto">
        <div className="h-[1690px] pt-4 flex-col flex gap-8 xl:h-[962px]">
        ...
        <div className="xl:flex xl:gap-[270px]">
          ...
          <div className="mt-12 xl:flex-1 xl:w-[584px]">
            <h3 className="font-sans font-[600] text-[24px] leading-8 text-gray-900 xl:text-[30px] dark:text-white">Curious about me? Here you have it:</h3>
            <div className="mt-6 flex flex-col gap-4 font-[400] text-[16px] leading-6 font-sans text-gray-600 dark:text-white">
